...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:27Z"), u1);
        Order o2 = new Order(null, Instant.parse("2019-06-20T19:42:37Z"), u2);
        Order o3 = new Order(null, Instant.parse("2019-06-20T19:33:17Z"), u1);
